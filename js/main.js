...
(function($) {
   ...
   /* Menu on Scrolldown
    * ------------------------------------------------------ */
    let clMenuOnScrolldown = function() {
        
        let menuTrigger = $('.header-menu-toggle');
   ...
   /* Stat Counter
    * ------------------------------------------------------ */
    let clStatCount = function() {
        
        let statSection = $(".about-stats"),
            stats = $(".stats__count");
